...
grep -Fq 'srv/playwright-setup.ts' "${test_directory}/contaminated.log"
grep -Fq 'usr/local/bin/http-server' "${test_directory}/contaminated.log"
grep -Fq 'usr/local/bin/serve' "${test_directory}/contaminated.log"
